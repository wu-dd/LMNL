...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, train=True,
                 transform=None, transform_strong=None, target_transform=None,
                 download=False,
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
            ...
            img_strong1 = self.transform_strong(img)
            img_strong2 = self.transform_strong(img)
            img_strong3 = self.transform_strong(img)
            # img_strong4 = self.transform_strong(img)
            # img_strong5 = self.transform_strong(img)
            # img_strong6 = self.transform_strong(img)
            # img_strong7 = self.transform_strong(img)
            # img_strong8 = self.transform_strong(img)

        if self.target_transform is not None:
            target = self.target_transform(target)

        return img_ori, img_strong1, img_strong2, img_strong3, target, index
