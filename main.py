...
# train models
    ...
    # evaluate models
    test_acc2 = evaluate(test_loader=test_loader, model=model2)
    print('test acc on test images is ', test_acc2)

    # evaluate models
    test_acc3 = evaluate(test_loader=test_loader, model=model3)
    print('test acc on test images is ', test_acc3)
